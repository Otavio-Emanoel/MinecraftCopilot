...
public class InventoryState extends BaseAppState {
    ...
    BlockType[] available = new BlockType[]{ BlockType.GRASS, BlockType.DIRT, BlockType.STONE, BlockType.WOOD, BlockType.LEAVES, BlockType.WATER, BlockType.EGG, BlockType.DEVFEST };
